...
public final class GetGameDetailUseCase_Factory implements Factory<GetGameDetailUseCase> {
  ...
  private GetGameDetailUseCase_Factory(Provider<GameRepository> repositoryProvider) {
  ...
  public static GetGameDetailUseCase_Factory create(Provider<GameRepository> repositoryProvider) {
    return new GetGameDetailUseCase_Factory(repositoryProvider);
  }

  public static GetGameDetailUseCase newInstance(GameRepository repository) {
