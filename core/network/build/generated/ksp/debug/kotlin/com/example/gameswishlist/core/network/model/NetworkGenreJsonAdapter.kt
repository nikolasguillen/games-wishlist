...
public class NetworkGenreJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<NetworkGenre>() {
  ...
  public override fun toString(): String = buildString(34) {
      append("GeneratedJsonAdapter(").append("NetworkGenre").append(')') }

  public override fun fromJson(reader: JsonReader): NetworkGenre {
    var id: Int? = null
  ...
  public override fun toJson(writer: JsonWriter, value_: NetworkGenre?): Unit {
    if (value_ == null) {
