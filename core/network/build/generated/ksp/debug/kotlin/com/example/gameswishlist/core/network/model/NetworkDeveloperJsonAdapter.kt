...
public class NetworkDeveloperJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<NetworkDeveloper>() {
  ...
  public override fun toString(): String = buildString(38) {
      append("GeneratedJsonAdapter(").append("NetworkDeveloper").append(')') }

  public override fun fromJson(reader: JsonReader): NetworkDeveloper {
    var id: Int? = null
    ...
    reader.endObject()
    return NetworkDeveloper(
        id = id ?: throw Util.missingProperty("id", "id", reader),
        name = name ?: throw Util.missingProperty("name", "name", reader)
    )
  }

  public override fun toJson(writer: JsonWriter, value_: NetworkDeveloper?): Unit {
    if (value_ == null) {
