...
public class NetworkPublisherJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<NetworkPublisher>() {
  ...
  public override fun toString(): String = buildString(38) {
      append("GeneratedJsonAdapter(").append("NetworkPublisher").append(')') }

  public override fun fromJson(reader: JsonReader): NetworkPublisher {
    var id: Int? = null
  ...
  public override fun toJson(writer: JsonWriter, value_: NetworkPublisher?): Unit {
    if (value_ == null) {
