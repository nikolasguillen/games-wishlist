...
public class NetworkPlatformJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<NetworkPlatform>() {
  private val options: JsonReader.Options = JsonReader.Options.of("id", "name", "slug")
  ...
  public override fun toString(): String = buildString(37) {
      append("GeneratedJsonAdapter(").append("NetworkPlatform").append(')') }

  public override fun fromJson(reader: JsonReader): NetworkPlatform {
    var id: Int? = null
  ...
  public override fun toJson(writer: JsonWriter, value_: NetworkPlatform?): Unit {
    if (value_ == null) {
